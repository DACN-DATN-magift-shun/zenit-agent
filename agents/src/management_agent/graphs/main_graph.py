...
from management_agent.nodes.confirm_node import ManagementAgentConfirmNode
...
class ManagementAgentMainGraph(BaseGraph):
    ...
    def build_state_graph(self):
        ...
        graph.add_node("confirm", ManagementAgentConfirmNode.get_user_confirmation)
        
        graph.add_edge(START, "extract_content")
        graph.add_edge("extract_content", "confirm")
